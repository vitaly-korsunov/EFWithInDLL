...
namespace ClassLibrary1
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual int AddEmploee(string lastName, string firstName, string city, string homePhone, Nullable<System.DateTime> birthDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddEmploee", lastNameParameter, firstNameParameter, cityParameter, homePhoneParameter, birthDateParameter);
        }
        ...
        public virtual int DeletDit(Nullable<int> employeeID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeletDit", employeeIDParameter);
        }
        ...
        public virtual ObjectResult<GetByName_Result> GetByName(string fname)
        {
            var fnameParameter = fname != null ?
                new ObjectParameter("fname", fname) :
                new ObjectParameter("fname", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetByName_Result>("GetByName", fnameParameter);
        }
    
        public virtual ObjectResult<GetEmpDit_Result> GetEmpDit()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEmpDit_Result>("GetEmpDit");
        }
        ...
        public virtual int UpdateEmployeesDit(Nullable<int> employeeID, string lastName, string firstName, string city, string homePhone, Nullable<System.DateTime> birthDate)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateEmployeesDit", employeeIDParameter, lastNameParameter, firstNameParameter, cityParameter, homePhoneParameter, birthDateParameter);
        }
    }
}
